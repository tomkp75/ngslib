...
import sys,copy
import argparse
from ngslib import Bed,IO,Utils
...
def argParser():
    ''' Parse arguments. '''
    p=argparse.ArgumentParser(description='Get unique Beds from a Bed file. Bed file should be sorted first.',epilog='dependency ngslib')

#!/usr/bin/python
#Last-modified: 08 Apr 2015 09:15:39 PM
...
def argParser():
    ...
    p.add_argument("-i","--input",dest='ifname',type=str,metavar="input.bed",required=True,help="Input file. When 'stdin' is specified, '-f' is required.")
    ...
    p.add_argument("-f","--format",dest="ftype",type=str,metavar="guess",default="guess",help="Format of input file. By default, the program will g uess the format by file extension. Choice can be from 'bed3', 'bedgraph', 'bed','peak','wig', 'sam2bed', 'any' or 'genepred'. If 'stdin' is used as input, format is required.")
